...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class BoneController : MonoBehaviour
    {
        ...
        //Adds the default bone that will replace all bones, that are not exist
        [SerializeField]
        [Tooltip("The bone that will replace all bones, that are not exist.")]
        Transform m_ApsentBone;
        public Transform ApsendBone
        {
            get
            {
                return m_ApsentBone;
        ...
        // sets all bones of m_BoneMapping to m_ApsentBone
        void SetDefaultBone()
        {
            for(int i =0;i<k_NumSkeletonJoints;i++)
                m_BoneMapping[i] = m_ApsentBone;
        }
