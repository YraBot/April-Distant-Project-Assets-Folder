...
namespace OpenCVForUnityExample
{
    ...
    public class OpenPoseExample : MonoBehaviour
    {
        ...
        /// </summary>
        WebCamTextureToMatHelperExample webCamTextureToMatHelperExample;
        ...
        void Start()
        {
            Invoke("govno_slona", 2f);
            Utils.setDebugMode(true);
            webCamTextureToMatHelperExample = gameObject.GetComponent<WebCamTextureToMatHelperExample>();
        ...
        {
            if (isWorking) {
                mat = webCamTextureToMatHelperExample.mat();
                g1(); 
            }
        }
        ...
        public void Run(Mat img)
        {
            ...
            string path = "dnn/ArtyomGay.jpg";
            string ifh = Utils.getFilePath(path);
            // Сохранение в файл
            File.WriteAllBytes(ifh, bytes);
